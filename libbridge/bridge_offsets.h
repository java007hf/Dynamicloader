...
enum bridgeOffsetModes {
    MEMBER_OFFSET_MODE_WITH_JIT,
    MEMBER_OFFSET_MODE_NO_JIT,
};
static bridgeOffsetModes offsetMode;
const char* bridgeOffsetModesDesc[] = {
    "WITH_JIT",
    "NO_JIT",
};
...
// helper to determine the required values (compile with BRIDGE_SHOW_OFFSET=true)
#ifdef BRIDGE_SHOW_OFFSETS
