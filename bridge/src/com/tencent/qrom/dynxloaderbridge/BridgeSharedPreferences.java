 ...
 */
public final class BridgeSharedPreferences implements SharedPreferences {
	...
	public BridgeSharedPreferences(File prefFile) {
		mFile = prefFile;
		startLoadFromDisk();
	}

	public BridgeSharedPreferences(String packageName) {
		this(packageName, packageName + "_preferences");
	}

	public BridgeSharedPreferences(String packageName, String prefFileName) {
	...
	private void startLoadFromDisk() {
		...
		new Thread("XSharedPreferences-load") {
			@Override
			public void run() {
				synchronized (BridgeSharedPreferences.this) {
					loadFromDiskLocked();
				}
			}
		}.start();
