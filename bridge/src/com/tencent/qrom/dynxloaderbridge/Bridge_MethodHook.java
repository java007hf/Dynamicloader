...
import com.tencent.qrom.dynxloadercallbacks.IBridgeUnhook;


public abstract class Bridge_MethodHook extends BridgeCallback {
	public Bridge_MethodHook() {
		super();
	}
	public Bridge_MethodHook(int priority) {
		super(priority);
	}
	...
	public static class MethodHookParam extends BridgeCallback.Param {
	...
	public class Unhook implements IBridgeUnhook {
		...
		public Bridge_MethodHook getCallback() {
			return Bridge_MethodHook.this;
		}

		@Override
		public void unhook() {
			Bridge.unhookMethod(hookMethod, Bridge_MethodHook.this);
		}
